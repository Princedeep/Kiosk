...
public class SplashPanel {
	...
	public void SplashPanel() {
		...
		btnScheduleAppointment.setForeground(new Color(60, 165, 38));
		btnScheduleAppointment.setBackground(Color.DARK_GRAY);
		btnScheduleAppointment.setOpaque(true);
		
		btnRoomFinder.setForeground(new Color(60, 165, 38));
		btnRoomFinder.setBackground(Color.DARK_GRAY);
		btnRoomFinder.setOpaque(true);
